...
main(int argc, char **argv) {
  ...
  if (argc < 9) {
  	cerr << "\nUsage: ./middle N lambda1 lambda2\n\n";
  	return 1;
  }
  ...
  //cout << "in main " << N << lambda1 << lambda2 << endl;

  Community c(filename, filename_w, type, -1, precision, N, lambda1, lambda2);
  ...
  do {
    ...
    //c.sizeForComm.resize(c.size);
    c = Community(g, -1, precision, N, lambda1, lambda2);
